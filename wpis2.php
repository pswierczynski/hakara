...
<body>
<?php
$_POST['tresc'] = mysql_real_escape_string($_POST['tresc']);
$sql = "INSERT INTO tekst VALUES(0, '".$_POST['tytul']."', '".$_POST['tresc']."', 0, '".$_GET['id']."');";
$wykonaj = mysqli_query($conn, $sql);

if($wykonaj){
echo '<center><table border="1" width="55%" height="17%" bordercolor="#4B565A" cellspacing="0" cellpadding="0"><tr><td bgcolor="#7C8F96" align="center"><a href="panel2.php">Tekst dodano pomylnie.</a><br><font size=1>Kliknij aby wrci.</td></tr></table></center>';
} else {
